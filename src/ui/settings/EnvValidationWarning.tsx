  ...
  return (
    ...
    >
      ...
      >
        <Tooltip
          title={
            'Click to open a gist with some explaining of the possible problem'
          }
        >
          <Typography
            style={{ cursor: 'pointer' }}
            onClick={() =>
              open('https://gist.github.com/rchurchley/cb8478caec1d1319abac')
            }
          >
        ...
        <Typography variant={'caption'}>
          This could be a sign that you need to set your launcher path from your
          terminal
        </Typography>
