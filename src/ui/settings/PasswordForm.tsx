  ...
  if (err !== null) {
    ...
    return (
      <Alert severity={'warning'}>
        {'Username not set, but is needed in order to save a ' +
          passwordPhrase +
          ' for this host.'}
      </Alert>
    );
    ...
    return (
      <Alert severity={'warning'}>
        {'Hostname not set, but is needed in order to save a ' +
          passwordPhrase +
          ' for this host.'}
      </Alert>
    );
        ...
        <Button
          ...
          onClick={() =>
            updatePassword(formPassword)
              ...
              .catch((e) => setErr(`Failed setting password: ${asString(e)}`))
          }
        >
          Update password
        </Button>
